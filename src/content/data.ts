  ...
  experience: [
    {
      ...
      // ...existing code...
      description: `
      Modernized core UI libraries, built CLI tools, improved CI/CD and dependency management, and created a Dev portal to streamline prototyping and enhance developer experience
      `,
      // ...existing code...
      techStack: ['Nx', 'RsPack', 'SWC', 'TypeScript', 'Docker', 'MUI', 'AG Grid', 'Apache ECharts'],
      subtitles: ['Senior Software Engineer Core UI Lead QTS'],
    },

    {
      ...
      description: 'Led development of high-performance trading UIs and financial data applications. Managed legacy Python app modernization, release processes, and CI/CD pipelines while collaborating with leadership.',
    ...
    },
    {
      ...
      company: 'Bank of America, London',
      description: 'Spearheaded transformation of legacy supervisory tool to modern React application. Implemented RESTful and WebSocket APIs, driving global adoption as bank\'s primary supervisory platform.',
